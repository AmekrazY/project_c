...
int main(void)
{
    ...
    do
    {
        ...
        scanf("%i", &age);                           // on demande de saisir l'age
        system("clear");
        printf("Votre age est incorrect veuilez saisir votre age !!! \n\n");
    }
    while (age <= 3);       // tant que l'age n'est pas valide on redemande de le saisir
    ...
    if (age < 11)  // 1er categorie ou l'age est inferieur a 11 ans
    {
        ...
        while ((r != 'o' || r != 'O') && (r != 'n' || r != 'N'));// on verifier si on a bien saisi la lettre 'o' pour oui ou 'n' pour non sinon on redemande
        ...
        else if (answer == 'n' || answer == 'N')
        {
            ...
            else if (answer2 == 'n' || answer2 == 'N')
            {
                ...
                else if (answer3 == 'n' || answer3 == 'N')
                {
                    ...
                    printf("Tapez 1 ou 2 :\n");
                    scanf("%i", &choix);        // on demande de choisir une des categorie en tapant 1 ou 2
                    if (choix == 1)
                    {
                        printf("****               ****\n");
                        for (int i = 0 ; i < 3 ; i++)
                        ...
                        printf("****               ****\n\n");
                        printf("Voulez vous voir un de ces films , tapez :\n1 pour %s\n2 pour %s\n3 pour %s\n", filmCategorieEnfant[0], filmCategorieEnfant[1], filmCategorieEnfant[2]);
                        scanf("%i", &c);
                        if (c == 1)
                        {
                            printf("Vous allez regarder le film\n %s\nBon film a bientot !", filmCategorieEnfant[0]);
                        }
                        else if (c == 2)
                        {
                            printf("Vous allez regarder le film \n%s\nBon film a bientot !", filmCategorieEnfant[1]);
                        }
                        else
                        {
                            printf("Vous allez regarder le film \n%s\nBon film a bientot !", filmCategorieEnfant[2]);
                        }
                    }
                    else if (choix == 2)
                    {
                        ...
                        if (c1 == 1)
                        {
                            printf("Vous allez regarder le film\n %s\nBon film a bientot !", filmCategorieAdos[0]);
                        }
                        else if (c1 == 2)
                        {
                            printf("Vous allez regarder le film \n%s\nBon film a bientot !", filmCategorieAdos[1]);
                        }
                        else
                        {
                            printf("Vous allez regarder le film \n%s\nBon film a bientot !", filmCategorieAdos[2]);
                        }
                    }
                }
